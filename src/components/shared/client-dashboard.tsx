                       ...
                       <div className="bg-card/90 border border-white/10 p-8 rounded-3xl w-full max-w-2xl shadow-2xl relative" onClick={e => e.stopPropagation()}>
                          ...
                          <div className="grid md:grid-cols-2 gap-6 mb-8">
                             ...
                             <div className="p-6 bg-white/5 rounded-2xl border border-white/5 space-y-4">
                                ...
                                <div><span className="text-muted-foreground text-xs font-bold w-16 inline-block">{t('total')}</span> <span className="font-black text-sm">{selectedBooking.totalPrice} AED</span></div>
                             </div>
                          </div>
