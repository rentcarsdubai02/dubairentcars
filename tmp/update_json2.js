...
const translations = {
  ...
  fr: {
    ...
    adminLocations: {
      ...
      title1: "Nos",
      title2: "Agences",
      subtitle: "Gérez vos points d'accès physiques à travers Cannes. Configurez les lieux de prise en charge et de retour.",
      activeHubs: "Agences Actives",
      registerTitle: "Enregistrer une Nouvelle Agence",
      pointNameLabel: "Nom de l'Agence",
      pointNamePlaceholder: "Centre Agence Cannes (Principal)",
  ...
  ar: {
    ...
    adminLocations: {
      ...
      title1: "إدارة",
      title2: "الوكالات",
      subtitle: "إدارة نقاط الوصول الفعلية الخاصة بك عبر كان. تكوين مواقع الاستلام والإرجاع.",
      activeHubs: "الوكالات النشطة",
      registerTitle: "تسجيل وكالة جديدة",
      pointNameLabel: "اسم الوكالة",
      pointNamePlaceholder: "مركز وكالةكان (الرئيسي)",
      addressLabel: "العنوان الفعلي",
      addressPlaceholder: "كان",
